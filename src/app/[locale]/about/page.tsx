  ...
  return (
    <main className="container-page py-12 sm:py-16">
      ...
      >
        ...
        <figure className="flex flex-col items-center gap-4 rounded-card border border-mm-blue-100 bg-mm-blue-900 px-8 py-12 text-center">
          {owner.photo ? (
            ...
            <span
              className="flex h-40 w-40 items-center justify-center rounded-card border border-dashed border-white/25 bg-white/5"
              aria-hidden
            >
          ...
          <figcaption className="font-sans">
            <span className="block font-display text-xl font-extrabold uppercase tracking-[-0.01em] text-white">
              {owner.name}
            </span>
            <span className="mt-1 block text-sm font-semibold text-mm-blue-300">
              {owner.role}
            </span>
          </figcaption>
        </figure>
        ...
        <div>
          ...
          <div aria-hidden className="mt-3 h-1 w-16 bg-mm-ember-600" />
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {values.map((value) => (
            <Card key={value.title}>
              <CardHeader>
                <span
                  className="inline-flex h-12 w-12 items-center justify-center rounded-control bg-mm-blue-100 text-mm-blue-600"
                  aria-hidden
                >
      ...
      <section aria-labelledby="timeline-heading" className="mt-16 sm:mt-20">
        ...
        <div aria-hidden className="mt-3 h-1 w-16 bg-mm-ember-600" />
        <ol className="mt-8 space-y-0 border-l-2 border-mm-blue-100 pl-8">
          {timeline.map((entry, index) => (
            <li key={entry.title} className={cn('relative', index !== timeline.length - 1 && 'pb-10')}>
              <span
                aria-hidden
                className="absolute -left-[2.6rem] top-1 flex h-6 w-6 items-center justify-center rounded-full bg-mm-ember-600 text-white"
              >
                <Icon name="check" size={14} />
              </span>
              <span className="font-sans text-xs font-semibold uppercase tracking-[0.18em] text-mm-ember-600">
                {entry.marker}
              </span>
              <h3 className="mt-1 font-display text-lg font-extrabold uppercase tracking-[-0.01em] text-mm-blue-900">
                {entry.title}
              </h3>
      ...
      <section
        ...
        className="mt-16 rounded-card bg-mm-blue-900 px-7 py-12 text-white sm:mt-20 sm:px-11"
      >
        <h2
        ...
        <p className="mt-3 max-w-[48ch] font-sans text-lg leading-relaxed text-mm-blue-300">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            ...
            className={cn(
              ...
              'bg-mm-ember-600 font-sans text-lg font-semibold text-white transition-colors hover:bg-mm-ember-700',
